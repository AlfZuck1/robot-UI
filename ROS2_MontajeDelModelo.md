...
# Dentro de Launch crear el archivo display.launch.py (Viene en la carpeta de pythonPrograms)

# Posteriomente, configurar el setup.py para que reconozca el paquete y las dependencias necesarias (Viene igual en pythonPrograms):
...
# Desde la terminal, dentro de la carpeta ros2_ws, ejecutar los siguientes comandos:
    ...
    # Se ejecuta el launch para que todos los nodos se ejecuten
